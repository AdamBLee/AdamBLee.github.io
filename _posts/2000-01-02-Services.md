...
# Beginner coding and computing <br>
### This class is a fun introduction to computing and coding.  In this course we use [Microsoft Makecode](https://www.microsoft.com/en-us/makecode/about){:target="_blank"} visual programming to code on the [BBC micro:bit](https://microbit.org/){:target="_blank"} 
