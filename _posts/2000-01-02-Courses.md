...
<div markdown="1">
<!-- Course Description -->
### This class is a fun introduction to computing and coding. Students will learn about what a computer is, and how to write a program.  Students will be able to share what they've learned about variables, loops, functions, and other fundamentals by coding with the [BBC micro:bit](https://microbit.org/){:target="_blank"}.  Upon completion of the course students will recieve their own micro:bit to take home to be able to continue their learning journey. 
</div>
<div>
<!-- photos-->
<figure>
