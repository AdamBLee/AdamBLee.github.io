...
## This class is a fun introduction to computing and coding.  Kids will use Microsoft Makecode visual programming language to learn the basics of programming.  They will also use the BBC micro:bit to interact direclty with their programs. . <br><br><br>

# Intro to robotics class<br>
<img src="img/family.jpg" width="45%" height="45%"/>
## This class is a very interactive and hands on introduction to the world of robotics.  Using both the BBC micro:bit and arduino as a base, the kids will learn how to use sensors and servos to bring a robot to life.  <br><br><br>
