...
<div class="container">
  ...
  <div class="mySlides">
    <div class="numbertext">10 / 13</div>
      <img src="img/codingClassWebSize/IMG_0115.JPG" style="width:80%"> 
       </div>

  <div class="mySlides">
    <div class="numbertext">11 / 13</div>
      <img src="img/codingClassWebSize/IMG_0123.jpg" style="width:80%"> 
       </div>

  <div class="mySlides">
    <div class="numbertext">12 / 13</div>
      <img src="img/codingClassWebSize/IMG_0133.jpg" style="width:80%"> 
       </div>

  <div class="mySlides">
    <div class="numbertext">13 / 13</div>
      <img src="img/codingClassWebSize/shopfest.jpg" style="width:80%"> 
       </div>
  ...
  <div class="row">
    ...
    <div class="column">
      <img class="demo cursor" src="img/codingClassWebSize/IMG_0115.jpg" style="width:80%" onclick="currentSlide(9)" alt="Captain Proton v2, ready to play rock-paper-scissors with students">
    </div>
    <div class="column">
      <img class="demo cursor" src="img/codingClassWebSize/IMG_0123.jpg" style="width:80%" onclick="currentSlide(9)" alt="Wheeled robots we use in class">
    </div>
    <div class="column">
      <img class="demo cursor" src="img/codingClassWebSize/IMG_0133.jpg" style="width:80%" onclick="currentSlide(9)" alt="BBC micro:bit with LED strips used to learn about hardware and loops">
    </div>
    <div class="column">
      <img class="demo cursor" src="img/codingClassWebSize/shopfest.jpg" style="width:80%" onclick="currentSlide(9)" alt="Adam and BreeAnne Lee at ShopFest, Eagle Mountain, UT">
    </div>
  </div>
</div>